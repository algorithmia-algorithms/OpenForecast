...
def test_train():
    ...
    input['checkpoint_output_path'] = "data://timeseries/generativeforecasting/btc_model_headers.t7"
...
def test_forecast():
    ...
    # input['checkpoint_input_path'] = "data://zeryx/forecasting_testing/sinewave_incremented_model.t7"
    # input['checkpoint_input_path'] = "data://timeseries/generativeforecasting/btc_model_headers.t7"
    input['image_save_path'] = "data://timeseries/generativeforecasting/btc_forecast.png"
    input['forecast_size'] = 140
    input['iterations'] = 30
    input['io_noise'] = 0.04
    return apply(input)
